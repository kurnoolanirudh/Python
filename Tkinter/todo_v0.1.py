import tkinter as tk  # themed tkniter (this will make elements look more native)
...
entry = ttk.Entry(frame)  # to put this entry in the frame
...
entry_btn.grid(row=0, column=2, padx=2, pady=2)
